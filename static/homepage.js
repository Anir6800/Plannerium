...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.downloadSamplePDF = async function() {
        const projectData = {
            project_name: 'Sample AI Project Plan',
            project_goal: 'Demonstration plan generated by Plannerium.',
            start_date: '2025-11-15',
            deadline: '2026-01-15',
            hours_per_week: 20,
            task_breakdown: [
                { task: 'Discovery', duration: '1 week' },
                { task: 'Design', duration: '2 weeks' },
                { task: 'Implementation', duration: '4 weeks' },
                { task: 'QA', duration: '2 weeks' }
            ],
            schedule: {
                title: 'Schedule Overview',
                phases: [
                    { phase: 'Init', weeks: 'Week 1' },
                    { phase: 'Build', weeks: 'Weeks 2-6' },
                    { phase: 'QA', weeks: 'Weeks 7-8' }
                ]
            },
            risk_analysis: {
                title: 'Risk Analysis',
                risks: [
                    { level: 'Low', description: 'Timeline variance' },
                    { level: 'Medium', description: 'Integration delays' },
                    { level: 'High', description: 'Resource availability' }
                ]
            }
        };
        ...
        try {
            ...
            if (response.ok) {
                ...
                a.href = url;
                a.download = data.filename || 'plannerium-sample-plan.pdf';
